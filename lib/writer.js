...
AttachmentWriter.prototype.end = function() {
  ...
  request(this.path, checkCurrentDoc);

  function checkCurrentDoc(err, res, body) {
    var currentDoc = {};
    var docKey;
    var aKey;
    ...
    for (aKey in writer._newAttachments) {
    ...
    request(putOpts, checkUploadSuccess);
  }

  function checkUploadSuccess(err, res, body) {
